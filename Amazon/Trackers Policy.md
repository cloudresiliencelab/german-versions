...
To learn more about how Amazon provides interest-based ads, please visit the [Interest-Based Ads notice](https://www.amazon.de/-/en/gp/help/customer/display.html?nodeId=G64JFZVFDY66XG9K). To adjust your interest-based ad preferences, please go to the [Advertising Preferences page](https://www.amazon.de/-/en/adprefs). You can see which approved third parties use cookies and manage how they use cookies by visiting our [Cookies and advertising choices page](https://www.amazon.de/-/en/privacyprefs/retail?oCT=ads).
...
See our [Privacy Notice](https://www.amazon.de/-/en/privacynotice) for more information about the types of information we gather.