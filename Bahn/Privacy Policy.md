...
Europa-Allee 70-76  
60486 Frankfurt  
E-Mail: [p.d-datenschutz@deutschebahn.com](mailto:p.d-datenschutz@deutschebahn.com)

**DB Fernverkehr AG**  
Europa-Allee 78-84  
60486 Frankfurt  
E-Mail: [fv-datenschutz@deutschebahn.com](mailto:fv-datenschutz@deutschebahn.com)

**DB Regio AG**  
Europa-Allee 70-76  
60486 Frankfurt  
E-Mail: [datenschutz.regio@deutschebahn.com](mailto:datenschutz.regio@deutschebahn.com)
...
Dieser werblichen Verwendung Ihrer Daten können Sie jederzeit mit Wirkung für die Zukunft widersprechen. Ihren Widerspruch können Sie per E-Mail an [p.d-datenschutz@deutschebahn.com](mailto:p.d-datenschutz@deutschebahn.com) richten (Stichwort: Werbewiderspruch). 

Im Folgenden finden Sie diejenigen Datenverarbeitungen näher beschrieben, die bei der Ticketbuchung über bahn.de stattfinden können. Informationen zu weiteren Datenverarbeitungen, beispielsweise wenn Sie unsere Seiten in sozialen Netzwerken besuchen, finden Sie unter: [https://www.db-fernverkehr.com/datenschutzhinweise](https://www.db-fernverkehr.com/datenschutzhinweise) sowie unter [www.db-vertrieb.com](https://www.db-vertrieb.com/dbvertrieb/datenschutzhinweise-11199940).

Dies betrifft im Einzelnen:

**DB Kundenkonto**  
Um ein DB Kundenkonto zur Buchung von Tickets auf bahn.de anzulegen, werden die folgenden Pflichtangaben im Rahmen der Registrierung erhoben:

*   E-Mail-Adresse (dient in Kombination mit dem Passwort zum Login)
*   Passwort (wird von Ihnen selbst vergeben)

Ohne Angabe dieser Daten kann kein persönliches Kundenkonto erstellt werden. Alle weiteren Angaben zu Ihrer Person und Ihrem Reiseprofil sind freiwillig bzw. für weitere Funktionen oder Dienste erforderlich, wenn Sie diese benutzen. Wir speichern Ihre Buchungsdaten, wozu auch die Angabe zum Vorhandensein einer BahnCard gehört, sowie Ihre Anmeldedaten in Ihrem Kundenkonto. Bitte informieren Sie sich im [Datenschutzhinweis zum DB Kundenkonto](https://www.bahn.de/datenschutz/datenschutz-kundenkonto) über die weitere Datenverarbeitung, die mit der Benutzung des Kundenkontos verbunden ist, und über die Möglichkeit zur Anbindung weiterer Apps und Dienste im Accountmanager Ihres Kundenkontos.

**Buchung eines Digitalen Tickets**   
Bei der Buchung von Digitalen Tickets werden Anrede, Vorname, Name und E-Mail-Adresse verarbeitet. Das berechtigte Interesse an der Verarbeitung der Anrede besteht in einer höflichen Kundenansprache. Sie haben die Wahl zwischen „Frau“, „Herr“ oder „neutrale Anrede“ und müssen sich somit keinem Geschlecht zuordnen. Es handelt sich technisch bedingt noch um ein Pflichtfeld. Beim Erwerb im personalbedienten Verkauf kann das digitale Ticket alternativ ohne Angabe einer E-Mailadresse als Ausdruck ausgegeben werden. Bei Buchung von internationalen Fahrkarten und einigen regionalen Angeboten kann zusätzlich das Geburtsdatum erforderlich sein. Im Zug werden bei der Kontrolle diejenigen Informationen im Kontrollgerät (mobilen Terminal) angezeigt, die sich auf dem Ticket befinden (Vorname und Name).

**Zahlungsdaten**  
Die DB Vertrieb GmbH ist Verantwortliche für das Forderungsmanagement im Personenverkehr der DB. Für die Abwicklung der von Ihnen veranlassten Zahlungen werden die erforderlichen Zahlungsdaten (Betrag, Buchungsreferenz, Buchungsbeschreibung, Zahlungspflichtiger) an die betreffenden Zahlungsdienstleister übermittelt. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b) DSGVO.

*   **Bei Bezahlung mit PayPal ist das:**  
    PayPal (Europe) S.à r.l. et Cie, S.C.A., 22-24 Boulevard Royal, L-2449 Luxembourg. Wie PayPal Ihre Daten verarbeitet, finden Sie im [Datenschutzhinweis von PayPal](https://www.paypal.com/de/webapps/mpp/ua/privacy-full?locale.x=de_DE).
*   **Bei Bezahlung mit Apple Pay (nur auf IOS Geräten) ist das:**  
    Apple Distribution International (Apple), Hollyhill Industrial Estate, Hollyhill, Cork, Irland. Wie Apple Ihre Daten für Apple Pay verarbeitet, finden Sie im Datenschutzhinweis von „Wallet & Apple Pay“ auf Ihrem Gerät oder bei [Apple](https://support.apple.com/de-de/HT203027).
*   **Bei Bezahlung mit Kreditkarte ist das:**  
    PAYONE GmbH, Lyoner Straße 9, 60528 Frankfurt am Main. Wie PAYONE Ihre Daten verarbeitet, finden Sie im [Datenschutzhinweis von PAYONE](https://www.payone.com/DE-de/dsgvo) bzw.  
    LOGPAY Financial Services GmbH, Schwalbacher Straße 72, D-65760 Eschborn. Wie LOGPAY Ihre Daten verarbeitet, finden Sie im [Datenschutzhinweis von LOGPAY](https://www.logpay.de/datenschutzhinweise.html).  
    Die Erfassung der Daten der Kreditkarte für die Zahlung oder für die Hinterlegung im eigenen Kundenkonto sowie etwaige Sicherheitsmaßnahmen wie 3D-Secure und starke Kundenauthentifizierung erfolgen unmittelbar beim Zahlungsdienstleister. Wir erhalten keinen Zugang zu Ihren vollständigen Kreditkartendaten und speichern nur eine interne Referenz zum Zahlungsmittel beim Dienstleister sowie eine gekürzte Kreditkartennummer, damit Sie sie wiedererkennen können. Für die Datenverarbeitung im Rahmen der Zahlungsabwicklung sind die Dienstleister verantwortlich.  
    Wann welcher Dienstleister zum Einsatz kommt, kann von der Verfügbarkeit oder der konkret in Anspruch genommenen Leistung abhängig sein, auf welche der jeweilige Dienstleister spezialisiert ist.
*   **Bei Bezahlung mit Bonvoyo ist das:**  
    PAYONE GmbH, Lyoner Straße 9, 60528 Frankfurt am Main. Wie PAYONE Ihre Daten verarbeitet, finden Sie im [Datenschutzhinweis von PAYONE](https://www.payone.com/DE-de/dsgvo).  
    Die Erfassung der Daten für die Zahlung oder für die Hinterlegung im eigenen Kundenkonto sowie etwaige Sicherheitsmaßnahmen wie 3D-Secure und starke Kundenauthentifizierung erfolgen unmittelbar beim Zahlungsdienstleister. Wir erhalten keinen Zugang zu Ihren vollständigen Kunden- und Kontendaten. 
*   **Anmeldung zum SEPA-Lastschriftverfahren:**   
    Bei der Anmeldung zum SEPA Lastschriftverfahren erteilen Sie ein SEPA-Mandat, auf dessen Basis die Zahlungen von Ihrem Bankkonto mittels SEPA-Lastschrift eingezogen werden, wenn Sie dieses Zahlungsmittel auswählen. Die Speicherung erfolgt in einem hierfür erforderlichen Kundenkonto.
*   **Online-Freischaltung des SEPA-Lastschriftverfahrens:**Online-Freischaltung des SEPA-Lastschriftverfahrens   
    Für die sichere Zahlung mit dem SEPA-Lastschriftverfahren stellen wir Ihnen Methoden zur Online-Überprüfung des Kontozugriffs per OpenBanking über die Tink Germany GmbH (Gottfried-Keller-Straße 33, 81245 München) oder Verimi GmbH (Oranienstraße 91, 10969 Berlin) oder zur Online-Identitätsprüfung über die Verimi GmbH bereit. In Abhängigkeit davon, welche Prüfmethode Sie auswählen, werden Ihre personenbezogenen Daten (die angegebene Bankverbindung, Name und Email-Adresse) unter Ihrer Anleitung an den Dienstleister übermittelt. Im sich automatisch öffnenden Dialog des Dienstleisters werden Sie durch die ausgewählte Funktion geführt und über jeden einzelnen Schritt der Datenverarbeitung informiert. Sobald Sie die Prüfung erfolgreich durchgeführt haben, können Sie mit dem Lastschriftverfahren bezahlen. Beide Dienstleister sind selbständig als Verantwortliche tätig. Die Verimi GmbH wird Ihnen die Nutzung Ihres Verimi Kundenkontos, falls vorhanden, oder die Anlage eines neuen Verimi Kundenkontos anbieten, dass Ihnen später auch bei anderen Identitätsprüfungsverfahren behilflich ist. Die Tink Germany GmbH und Verimi GmbH sind zugelassene Kontoinformationsdienste, die auch für Banken tätig sind, und verarbeiten Ihre Daten nur für die wenigen Minuten der Kontozugriffsprüfung.   
    Weitere Informationen erhalten Sie auch im Datenschutzhinweis im Dialogfenster des jeweiligen Anbieters. 

Für Zwecke der Betrugsprävention wird mithilfe eines Auftragsverarbeiters ein Fingerprint Ihres Gerätes oder Browsers zusammen mit den Zahlungsdaten verarbeitet. Dies dient Ihrem und unserem Schutz, um der missbräuchlichen Verwendung Ihres Zahlungsmittels zur Zahlung bei [bahn.de](http://bahn.de/) vorbeugen zu können. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 lit. f) DSGVO.
...
Um Ihre Privatsphäre und die Verfügbarkeit der Website vor automatisierten und missbräuchlichen Zugriffsversuchen zu schützen, setzen wir Sicherheitstechnologien des Anbieters Akamai Technologies GmbH (Parkring 22, 85748 Garching) ein. Zur Bot-Erkennung und -Abwehr sowie für Risikobewertungen wird maschinelles Lernen eingesetzt. Hierbei können Messergebnisse und Verbindungsparameter für Prüfzwecke in Ihrem Gerät z.B. in Cookies bis zu einem Monat zwischengespeichert werden. Rechtsgrundlage für den Einsatz der Technologie ist § 25 Abs. 2 Nr. 2 TDDDG in Verbindung mit Art. 6 Abs. 1 lit. f) DSGVO. Das berechtigte Interesse besteht im Schutz der Daten der betroffenen Personen und der Infrastruktur vor automatisierten und missbräuchlichen Zugriffsversuchen.

**JSC-Tools von Risk.Ident GmbH**   
Für Zwecke der Betrugsprävention verwenden wir die Technologie JSC-Tools der Risk.Ident GmbH (Am Sandtorkai 50, 20457 Hamburg). Dies dient Ihrem und unserem Schutz, um der missbräuchlichen Verwendung Ihres Zahlungsmittels zur Zahlung bei bahn.de vorbeugen zu können. Hierbei kann ein Cookie mit einer Laufzeit von 24 Monaten verarbeitet werden. Rechtsgrundlage hierfür ist § 25 Abs. 2 Nr. 2 TDDDG in Verbindung mit Art. 6 Abs. 1 lit. f) DSGVO. Das berechtigte Interesse besteht in der Ermöglichung des einfachen und niedrigschwelligen Zugangs zu Buchungs- und Zahlungsdiensten bei gleichzeitig hoher Zahlungssicherheit. 

**easy Marketing**   
Mit den Technologien von easy Marketing GmbH (Asselner Hellweg 124, 44319 Dortmund) stellen wir die Vergütung von Partnerunternehmen sicher, falls Sie eine Buchung auf bahn.de nach Klick auf einen DB-Affiliate-Link bzw. Werbemittel durchgeführt haben. Hierfür werden Cookies mit einer Laufzeit von 12 Monaten ausgewertet, in die Sie zuvor auf diesen Partner-Sites eingewilligt haben. Rechtsgrundlage für den Einsatz der Technologie ist § 25 Abs. 2 Nr. 2 TDDDG in Verbindung mit Art. 6 Abs. 1 lit. f) DSGVO. Das berechtigte Interesse liegt dabei darin, die Affiliate-Abrede für den herbeigeführten Ticket-Kaufvertrag entsprechend vergüten zu können. 
...
Zum Zweck der Wegbeschreibung oder Umgebungsinformation können Sie sich Reisedetails grafisch auf einer Umgebungskarte anzeigen lassen, indem Sie diese Funktion über das Kartensymbol wählen. Hierfür wird der Kartendienst Google Maps der Google Inc. (1600 Amphitheatre Parkway, Mountain View, CA 94043, USA) genutzt. Nachdem Sie der Aktivierung zugestimmt haben, werden Ihre IP-Adresse und Positionsdaten (falls freigegeben) sowie die gewünschten Inhaltsdaten durch den Kartendienst eigenverantwortlich verarbeitet und die Karte angezeigt. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 lit. a) DSGVO. Die Aktivierung wird in einem eigenen Cookie vermerkt und gilt so lange, bis Sie die Schaltfläche "Karte deaktivieren" in der linken unteren Kartenecke betätigt oder das Cookie gelöscht haben. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 lit. b) DSGVO.

#### Cookies und ähnliche Technologien, die für die Nutzung bestimmter Funktionen der Website nicht erforderlich sind

Die nachfolgenden Cookies sind nicht zwingend für die Nutzung der Website erforderlich und werden nur dann verarbeitet, wenn Sie zuvor eingewilligt haben. Rechtsgrundlage hierfür ist § 25 Abs. 1 TDDDG in Verbindung mit Art. 6 Abs. 1 lit. a) DSGVO. Sie können Ihre Einwilligung jederzeit widerrufen, indem Sie die Cookie-Einstellungen erneut aufrufen und Ihre Auswahl dort ändern. 
...
Informieren Sie sich hier darüber, [welche Daten wir zum Zwecke der Abwicklung Ihrer Fahrgastrechte erheben](https://www.bahn.de/datenschutz/datenschutz-fahrgastrechte).
