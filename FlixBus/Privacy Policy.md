...
Wir, die Flix SE samt unserer Tochtergesellschaften (nachfolgend gemeinsam: "**FlixBus**", "**wir**" oder "**uns**") möchten Sie an dieser Stelle über den Datenschutz bei FlixBus informieren.
...
[Datenschutzhinweise für Bewerber](https://global.flixbus.com/company/jobs/privacy-policy)
...
*   Beförderer (eine Übersicht der aktuellen Beförderer finden Sie [hier](https://www.flixbus.de/abb-auswahl))
*   (IT-)Dienstleister
...
Informationen zu FlixBus und den von uns angebotenen Leistungen erhalten Sie insbesondere unter [www.flixbus.de](https://www.flixbus.de/) / [www.flixtrain.de](https://www.flixtrain.de/) samt den dazugehörigen Unterseiten (nachfolgend gemeinsam auch "**Website**“ oder "**Webseiten**"). Bei einem Besuch unserer Webseiten werden personenbezogene Daten von Ihnen verarbeitet.
...
Einige dieser Daten nutzen wir darüber hinaus auch für Produktempfehlungen, siehe Ziffer 2.1.5 sowie für den Newsletter, siehe Ziffer 2.1.6 und das Kundenkonto, siehe Ziffer 2.1.7.
...
### 2.1.4 Übermittlung an Behörden
...
Der Verwendung Ihrer E-Mail-Adresse zu diesem Zwecke können Sie jederzeit über den Abmeldelink der Produktempfehlung oder durch eine Nachricht an [unsubscribe@flixbus.com](mailto:unsubscribe@flixbus.com) widersprechen.
...
Die Verwendung Ihrer E-Mail-Adresse können Sie jederzeit über den Abmeldelink des Newsletters oder durch eine Nachricht an [unsubscribe@flixbus.com](mailto:unsubscribe@flixbus.com) widerrufen. Die Rechtmäßigkeit der bereits erfolgten Datenverarbeitungsvorgänge bleibt vom Widerruf unberührt.
...
*   E-Mail-Adresse (für alle anderen Länder),
...
### 2.1.9 Maschinelles Lernen und dynamische Anpassung der Website/App

Wir nutzen maschinelles Lernen zur Optimierung und Automatisierung unserer Prozesse. Dazu gehört das Trainieren einer systemgestützten Entscheidungslogik basierend auf Anwendungsfällen, d. h. das System kann aus der Vergangenheit lernen und Algorithmen verwenden, um statistische Modelle zu entwickeln, die in Zukunft auf ähnliche Aufgaben angewendet werden können.

Wir verwenden beispielsweise maschinelles Lernen in einem gesicherten und gehashten Modell, um schnell und unkompliziert individuelle Reiseangebote für Sie zu erstellen. Hierzu verwenden wir Rahmendaten, insbesondere die Benutzer-ID, den entsprechenden Reise- und Suchverlauf sowie die IP-Adresse. 

Darüber hinaus verwenden wir Daten zur automatischen Anpassung unserer Website und App, um Ihnen die bestmögliche Erfahrung zu bieten. So können wir zum Beispiel Ihren Kaufverlauf nutzen, um Ihnen zusätzliche Dienstleistungen anzubieten (z. B. das Hinzufügen einer Sitzplatzreservierung, die Kaufoption für die Mitführung von Zusatzgepäck) oder Sie bei Ihrem Benutzererlebnis zu unterstützen (z. B. wenn Sie kurz vor einer Reise stehen, könnten wir Sie auf die Echtzeitverfolgung Ihres Busses hinweisen).

Hierzu nutzen wir neben den oben aufgeführten Rahmendaten auch den Kaufverlauf und Kontakte mit Flix über den Kundendienst. Die Daten werden durch „Salting“ zusätzlich gesichert und gehasht, um eine zusätzliche Schutzebene bereitzustellen.     

Diese Verarbeitung stützt sich auf unser berechtigtes Interesse gemäß Art. 6 Abs. 1 (f) DSGVO, da wir ein wirtschaftliches Interesse daran haben, Ihnen die bestmögliche Erfahrungen anzubieten. Auch Sie profitieren davon, da Sie statt einer Standardempfehlung ein Reiseangebot erhalten, das auf Ihre Bedürfnisse zugeschnitten ist, oder wir machen Sie auf Dienstleistungen aufmerksam, die Ihre Planung, Reise und Ihre Erfahrung nach der Reise optimieren.

Wenn Sie der Verarbeitung Ihrer Daten zum Zweck des maschinellen Lernens oder der dynamischen Anpassung der Website/App widersprechen möchten, können Sie dies gemäß den gesetzlichen Bestimmungen jederzeit tun, indem Sie Ihren Widerspruch per E-Mail an [data.protection@flixbus.com](mailto:data.protection@flixbus.com) senden. Bitte beachten Sie, dass Sie in diesem Fall nur noch Standarddienstleistungen erhalten.

### 2.1.10 Betrugsprävention
...
Zusätzlich bieten wir Ihnen einen Kundenservice-Chatbot an. Folgende Daten werden verwendet:

*   Personenbezogene Daten: z. B. Nachname, Vorname, Geburtsdatum (falls nötig), Geschlecht (falls nötig)
*   Kontaktdaten: z. B. E-Mail-Adresse, Telefonnummer
*   Technische Daten: z. B. IP-Adresse, Sitzungs-ID

Dieser Chatbot ist ein KI-System. Ihre Daten werden nicht zu Trainingszwecken verwendet. Die Rechtsgrundlage für die Verarbeitung Ihrer personenbezogenen Daten ist Art. 6 (1) (b), (c) und (f) DSGVO.

### 2.3 Auftritte in Social-Media-Kanälen

Wir unterhalten Auftritte in Social-Media-Kanälen (derzeit: Facebook, Instagram, LinkedIn, X, TikTok). Soweit wir die Kontrolle über die Verarbeitung Ihrer Daten haben, stellen wir sicher, dass die geltenden Datenschutzbestimmungen eingehalten werden.
...
Facebook (Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Dublin 4, Irland) 

Instagram (Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Dublin 4, Irland) 

X (X Internet Unlimited Company, One Cumberland Place, Fenian Street, Dublin 2, D02 AX07, Irland)
...
### 2.4 Meldungen auf Speakout@Flix (Hinweisgeberportal)

Wenn Sie uns über unser Hinweisgeberportal „Speakout@Flix“ kontaktieren, erfassen wir die personenbezogenen Daten, die Sie aus eigener Initiative bereitstellen (z. B. Name und E-Mail-Adresse). Sie können eine Meldung über das Webportal oder telefonisch vornehmen. 

Ihre personenbezogenen Daten werden nur für die Verarbeitung Ihrer Meldung und für potenzielle interne Untersuchungen, die nach Ihrer Meldung durchgeführt werden, verwendet.
