...
Im Folgenden finden Sie zunächst eine Aufstellung der Zwecke, zu denen wir auf dieser Webseite Daten über Sie verarbeiten und weiter unten (Ziffer 3.), welche Daten das genau sind.

### 2.1 Technische Bereitstellung unserer Webseite

Wir verwenden die unter Ziffer 3.1 bezeichneten Daten bei jeder Nutzung unserer Angebote für deren störungsfreies Funktionieren, insbesondere die Darstellung von Inhalten, Sprachen, Bildern und Funktionen wie einem Warenkorb. Diese Daten werden nach dem Schließen Ihres Browsers gelöscht.
...
Die Verwendung der unter Ziffer 3. genannten Daten zu diesem Zweck erfolgt gem. Art. 6 (1) b DSGVO auf Grundlage des Vertrages, der zwischen uns und Ihnen mit Anlegen des Accounts zustande kommt.
...
Dabei gibt es im Wesentlichen zwei Möglichkeiten, wie wir Cookies verwenden. Zunächst verwenden wir technisch notwendige Cookies zum Betrieb unserer Webseite (siehe oben Ziffer 2.1). Hierbei ist unser berechtigtes Interesse gem. Art. 6 (1) f DSGVO an einem störungsfreien Betrieb unserer Webseite die Rechtsgrundlage zur Verwendung dieser Cookies.
...
#### 2.8.1 Informationen auf einem Gerät speichern und/oder abrufen
...
#### 2.8.2 Einfache Anzeigen und Anzeigenmessung
...
#### 2.8.3 Personalisiertes Anzeigenprofil und Einblendung
...
#### 2.8.4 Personalisierte Inhalte, Inhaltemessung, Erkenntnisse über Zielgruppen und Produktentwicklung
...
Auf unserer Webseite binden wir regelmäßig auch Inhalte von Drittanbietern ein - z.B. aus „sozialen“ Netzwerken wie Youtube, X oder Instagram. Um diese Inhalte auf unseren Angeboten einbetten und anzeigen zu können ist es technisch erforderlich, Ihre IP-Adresse an den Betreiber des jeweiligen Dienstes weiterzugeben (genaueres unter Ziffer 3. unten).
...
*   Die unter Ziffer 3. genannten Daten werden auch zu diesem Zweck erhoben und verwendet
...
### 3.7 Einbindung externer Inhalte
