...
*   [1\. Zugang zu Inhalten](#1-zugang-zu-inhalten)
...
GALA.de bietet hochwertige, an journalistischen Standards orientierte Inhalte. Dieses Angebot in Web und App können Sie über Werbung finanziert nutzen; alternativ bieten wir Ihnen einen Service zum werbe- und tracking-freien Zugang an. Dieser Service nennt sich contentpass und ist ein Angebot der Content Pass GmbH, Wolfswerder 58, 14532 Kleinmachnow, Deutschland. Beim Abschluss des Service wird contentpass Ihr Vertragspartner. Weitere Informationen zu diesem Service finden Sie auf [contentpass.net](https://www.contentpass.net/de).

Sie können sich [hier](https://www.contentpass.net/login) in Ihren contentpass-Account einloggen, und sich [hier](https://www.contentpass.net/signup) für contentpass anmelden.

### Zustimmung widerrufen

Ihre Zustimmung zur Nutzung unseres werbefinanzierten Angebots könenn Sie selbstverständlich jederzeit widerrufen. Klicken Sie dafür auf den Button "Zustimmung widerrufen". Die weitere Nutzung unseres Online-Angebotes ist dann jedoch nur als contentpass-Nutzer möglich.

Sie haben Ihre eventuell gegebene Zustimmung widerrufen.

Sollten Sie Ihre Zustimmung widerrufen, werden Sie beim nächsten Besuch unserer Website erneut darum gebeten, Ihre Zugangsart zu wählen. Auf der entsprechenden Auswahlseite können Sie sich nochmals zwischen der kostenfreien Nutzung mit Werbung und Tracking oder der als contentpass-Nutzer frei von Werbebannern, Videowerbung und personalisiertem Tracking entscheiden. 
...
FUNKE Women, People & Family GmbH
...
*   Für die Erhebung und Verarbeitung von Nutzungsinformationen zum Zweck der Messung ist die FUNKE Women, People & Family GmbH verantwortlich.
*   Für die Nutzung von Datenschutzeinstellungen des Privacy Centers sind wir zusammen mit der FUNKE Women, People & Family GmbH verantwortlich.

Ihre Datenschutzrechte können Sie sowohl bei uns wie unter Ziffer 1 näher beschrieben, als auch bei der FUNKE Women, People & Family GmbH unter den oben in diesem Abschnitt angeführten Kontaktdaten geltend machen. Sie erhalten eine Auskunft grundsätzlich von der Stelle, bei der Rechte geltend gemacht wurden. Den Datenschutzbeauftragten der FUNKE Women, People & Family GmbH erreichen Sie unter der oben genannten Adresse oder Mail-Adresse und dem Stichwort “Datenschutzbeauftragter”.

Ausschließlich die Nutzungsdaten der Panellisten können anhand einer Zuordnung der dynamisch erzeugten Zufallskennung zur ihrer Teilnehmerkennung einer bestimmten Person zugeordnet werden. Panellisten haben zu diesem Zweck eine spezielle Software auf ihrem Endgerät installiert und mit dem Betreiber des Messsystems, der Nielsen Media Germany GmbH, eine Vereinbarung geschlossen. Dieser Teil der Verarbeitung geschieht auf Rechtsgrundlage eines Vertrags gemäß Art. 6 Abs. A lit. b) DSGVO. Wir, sowie die FUNKE Women, People & Family GmbH, haben keinen Zugriff auf die Daten der Studienteilnehmer oder deren Zuordnung zu Nutzungsdaten. Panellisten finden die zu dieser Verarbeitung gehörende Datenschutzerklärung in ihrem Teilnehmerportal.

### 2.11 Anzeigen von Fremdinhalten (Soziale Netzwerke, Videos)

Auf unserer Webseite binden wir regelmäßig auch Inhalte von Drittanbietern ein - z.B. aus „sozialen“ Netzwerken wie Youtube, Twitter oder Instagram. Um diese Inhalte auf unseren Angeboten einbetten und anzeigen zu können ist es technisch erforderlich, Ihre IP-Adresse an den Betreiber des jeweiligen Dienstes weiterzugeben (genaueres unter Ziffer 3 unten).
...
Wir speichern in zu diesem Zweck Ihre Zustimmung zur Übermittlung Ihrer IP-Adresse für die Dauer von drei Jahren in Form eines Log-Eintrags zu Zwecken unserer Nachweispflicht gem. Art. 7 (1) DSGVO.

### 2.12 Social Sharing

Wir verwenden auf unserer Webseite sog. Social Sharing, die es Ihnen ermöglichen Seiteninhalte von uns auf Ihrem jeweiligen Social Media Profil zu teilen.

Weil hierbei notwendigerweise immer Daten von uns an das jeweilige Netzwerk übermittelt werden müssen, benötigen wir hierzu Ihre gesonderte Zustimmung, sofern Sie nicht bereits in den Datenschutz-Einstellungen eingewilligt haben. Hierzu verwenden wir die sogenannte zwei-Klick-Lösung auf unserer Webseite. Das bedeutet, dass Sie den Social Media Sharing Button erst gezielt durch einen Klick freischalten müssen.

Sofern Sie den Button freischalten, wird Ihre IP-Adresse zur Funktionsherstellung an das „soziale“ Netzwerk auf Basis Ihrer Einwilligung gem. Art. 6 (1) a DSGVO übermittelt und Sie können Inhalte im Rahmen Ihres dort bestehenden Kontos teilen. Bitte lesen Sie sich die Datenschutzhinweise des jeweiligen Netzwerks durch, um zu erfahren, wie Ihre Daten dort verwendet werden.

Bitte beachten Sie, dass diese Übermittlung in den Verantwortungsbereich des „sozialen“ Netzwerks bedeutet, dass wir weder Kontrolle noch die Verantwortung für dort erfolgende Datenverarbeitungen übernehmen können. Mit diesem Transfer ist auch eine Übermittlung in Länder außerhalb der EU (Drittland) verbunden, wo nicht immer das gleiche Datenschutzniveau wie in der EU sichergestellt ist. 
...
*   [Datenschutz](https://www.gala.de/service/themen/datenschutz-21129474.html)