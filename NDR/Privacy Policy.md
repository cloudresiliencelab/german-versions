...
*   Techniken der Firma Piano Software Inc, vormals AT Internet zur Ermittlung der anonymen statistischen Kennwerte ([https://piano.io](https://piano.io/ "https://piano.io")) Auf dieser Webseite werden Informationen über die Nutzung auch mit einem Verfahren von Piano in anonymisierter Form gesammelt und gespeichert. Dabei wird – wie bei dem SZMnG-Verfahren ein JavaScript in abrufbare Internetseiten eingebaut, um die Messung von Zugriffszahlen z. B. mittels eines Cookies zu ermöglichen. Zudem werden Audio- und Videonutzung innerhalb des Players auf den Webseiten erfasst. In keinem Fall können dabei die gewonnenen Daten dazu verwendet werden, den Besucher dieser Webseite persönlich zu identifizieren. Die gesammelten Daten werden lediglich zur Verbesserung des Angebotes genutzt. Deshalb werden alle IP-Adressen nur in anonymisierter Form gespeichert. Eine andere Verwendung oder Weitergabe an Dritte erfolgt nicht. Sie können aber der vollkommen anonymen Analyse Ihres Surfverhaltens hier widersprechen (s.u.). 

*   Das „AGF-Zählpixel“ der Firma Nielsen ([https://www.nielsen.com/de](https://www.nielsen.com/de/ "Link")) Auf dieser Webseite werden Informationen über die Videonutzung auch mit einem Verfahren von Nielsen in anonymisierter Form gesammelt und gespeichert. Dabei wird – wie bei dem SZMnG-Verfahren – eine kleine Bilddatei bzw. ein JavaScript in abrufbare Internetseiten eingebaut, um die Messung der Videonutzung z. B. mittels eines Cookies zu ermöglichen. In keinem Fall können dabei die gewonnenen Daten dazu verwendet werden, den Besucher dieser Webseite persönlich zu identifizieren. Die gesammelten Daten werden lediglich zur Verbesserung des Angebotes genutzt. Deshalb werden alle IP-Adressen nur in anonymisierter Form gespeichert.

**Hinweis**

Sie können die anonymen Analysen des Nutzungsverhaltens unterbinden, indem Sie dieses Häkchen setzen:

 Es sollen keine Daten für statistische Analysen übermittelt werden.

  

Mit dem Setzen des Häkchens wird ein Local-Storage Eintrag auf Ihrem Gerät abgelegt, der die weitere Erfassung der Nutzungsvorgänge verhindert. Bitte beachten Sie, dass es durch Updates der Browser (z.B. Mozilla Firefox) oder anderweitige Änderungen der nutzerseitigen Einstellungen vorkommen kann, dass der Eintrag gelöscht wird. Wir bitten Sie daher, die Wirksamkeit des Opt-Outs bei derartigen Änderungen nochmals zu überprüfen.
...
Unser Angebot richtet sich an alle Menschen, die sich informieren möchten. Wir bitten aber darum, dass Kinder und Personen unter 18 Jahren uns ohne Zustimmung der Eltern oder Erziehungsberechtigten keine personenbezogenen Daten übermitteln. Erläuterungen für Kinder zum Datenschutz finden Sie auf der Seite des Rundfunkdatenschutzbeauftragten unter  
[https://www.ndr.de/der\_ndr/unternehmen/organisation/Datenschutz-im-NDR,datenschutz6.html](https://www.ndr.de/der_ndr/unternehmen/organisation/Datenschutz-beimNDR,datenschutz6.html "Link").
...
Wir erheben und verwenden personenbezogene Daten nur mit Ihrer ausdrücklichen Einwilligung. Die uns im Rahmen der Nutzung unserer Online-Serviceangebote wie z. B. Newsletter, Gewinnspiele und Umfragen mitgeteilten Daten werden dabei nur insoweit gespeichert und verarbeitet, als es für die Nutzung der Angebote erforderlich ist. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 S. 1 lit. a) DSGVO. Im Einzelnen wird auf die jeweiligen Bedingungen dieser Services verwiesen. Ihre Daten werden gelöscht, sobald sie für die Erreichung des Zweckes ihrer Erhebung nicht mehr erforderlich sind. Für die personenbezogenen Daten, die im Rahmen der Nutzung unserer Services und Dienste erhoben worden sind, ist dies bei deren Beendigung der Fall.

5.1 Newsletter
--------------

Es besteht die Möglichkeit kostenfreie Newsletter zu abonnieren. Dabei wird bei der Anmeldung zum Newsletter die E-Mailadresse und optional ein Name aus der Eingabemaske übermittelt. Zudem werden Datum und Uhrzeit der Registrierung bei der Anmeldung erhoben. Für die Verarbeitung der Daten wird im Rahmen des Anmeldevorgangs Ihre Einwilligung eingeholt und auf diese Datenschutzerklärung verwiesen. Rechtsgrundlage für die Verarbeitung der Daten nach Anmeldung zum Newsletters durch Sie ist bei Vorliegen Ihrer Einwilligung Art. 6 Abs.1 lit. a) DSGVO. Die Erhebung Ihrer E-Mail-Adresse dient dazu, den Newsletter zuzustellen.

Für die Anmeldung zum Newsletter verwenden wir das sogenannte Double-opt-in-Verfahren. Das heißt, der NDR sendet Ihnen nach Ihrer Anmeldung eine E-Mail an die angegebene E-Mail-Adresse. In dieser E-Mail wird um die Bestätigung gebeten, dass Sie den Versand des Newsletters wünschen. Dabei wird Ihre Bestätigung und deren Zeitpunkt gespeichert. Wenn Sie Ihre Anmeldung nicht innerhalb von 24 Stunden bestätigen, wird Ihre E-Mail-Adresse automatisch gelöscht.

Für die Versendung von Newslettern verwendet der NDR ein webbasiertes Tool der ARD. Die zum Bezug des Newsletters eingegebenen Daten ( E-Mail-Adresse und optional Name) werden auf Servern des Saarländischen Rundfunks (SR, Funkhaus Halberg, 66100 Saarbrücken) in Deutschland gespeichert. Zudem werden Daten zu den Öffnungsraten, Anzahl der Versendeten Newsletter und angeklickten Links gespeichert.
...
*   **Infografiken von Datawrapper:** Über die "Embed"-Funktion werden Grafiken und Charts in das Internetangebot integriert, um komplexe Sachverhalte visualisieren zu können. Datenschutzhinweise von Datawrapper: [Datawrapper](https://www.datawrapper.de/terms/ "Datenschutz Datawrapper")
*   **Infografiken von infratest Dimap:** Über die "Embed"-Funktion werden Grafiken und Charts in das Internetangebot integriert. Datenschutzhinweise von Infratest Dimap: [Infratest Dimap](https://www.infratest-dimap.de/kontakt/datenschutz/ "Datenschutz Infratest Dimap")
*   **Inhalte von Facebook**: Über die "Embed"-Funktion integriert der NDR Inhalte seiner eigenen Facebook-Präsenzen oder die anderer Anbieter in das Internetangebot. Zu den Datenschutzhinweisen von Facebook: [Facebook](https://www.facebook.com/privacy/explanation "Datenschutz Facebook")
*   **Inhalte von Youtube:** Mit dem YouTube-Player integriert der NDR eigene Videos aus seinen YouTube-Channels oder Videos anderer Anbieter in das Internetangebot. Zu den Datenschutzhinweisen von Google: [Youtube](https://support.google.com/youtube/answer/2801895?hl=de "Datenschutz Youtube")
*   **Inhalte von Vimeo:** Mit dem Vimeo-Player integriert der NDR eigene Videos oder Videos anderer Anbieter in das Internetangebot. Zu den Datenschutzhinweisen von Vimeo: [Vimeo](https://vimeo.com/privacy "Datenschutz Vimeo")
*   **Inhalte von X:** Über die "Embed"-Funktion integriert der NDR Inhalte seiner eigenen X-Präsenzen oder die anderer Anbieter in das Internetangebot. Zu den Datenschutzhinweisen von X: [X](https://twitter.com/de/privacy "Datenschutz X")
*   **Inhalte von Instagram:** Die "Embed“-Funktion von Instagram ermöglicht es, Bilder und Videos von Instagram in das Internetangebot des NDR zu integrieren. Zu den Datenschutzhinweisen von Instagram: [Instagram](https://www.instagram.com/legal/privacy/ "Datenschutz Instagram")
*   **Inhalte von Tiktok:** Die "Embed“-Funktion von Tiktok ermöglicht es, Bilder und Videos von Tiktok in das Internetangebot des NDR zu integrieren. Zu den Datenschutzhinweisen von Tiktok: [Tiktok](https://www.tiktok.com/legal/page/eea/privacy-policy/de-DE "Datenschutz Tiktok")
...
*   Datenschutz bei X: [https://x.com/de/privacy](https://x.com/de/privacy "Datenschutzinformationen bei X")
*   Datenschutz bei Instagram: [https://help.instagram.com/519522125107875](https://help.instagram.com/519522125107875 "Datenschutz bei Instagram")
*   Datenschutz bei Pinterest: [https://policy.pinterest.com/de/privacy-policy](https://policy.pinterest.com/de/privacy-policy "Datenschutz bei Pinterest")
*   Datenschutz bei Alexa: [https://amazon.de/gp/help/customer/display.html](https://www.amazon.de/gp/help/customer/display.html/ref=footer_privacy?nodeId=GX7NJQ4ZB8MHFRNJ "Datenschutz Amazon Alexa")...
*   Datenschutz bei Google Play: [https://policies.google.com/privacy](https://policies.google.com/privacy "Datenschutz Google Play")
*   Datenschutz bei Facebook: [https://de-de.facebook.com/help/568137493302217](https://de-de.facebook.com/help/568137493302217 "Datenschutz Facebook")
*   Datenschutz bei Youtube: [https://policies.google.com/privacy?hl=de](https://policies.google.com/privacy?hl=de "Datenschutz Youtube")
*   Datenschutz bei TikTok: [https://www.tiktok.com/legal/page/eea/privacy-policy/de](https://www.tiktok.com/legal/page/eea/privacy-policy/de "Datenschutz TikTok")
*   Datenschutz bei Bluesky: [https://bsky.social/about/support/privacy-policy](https://bsky.social/about/support/privacy-policy "Datenschutz Bluesky") 
...
Der NDR stellt eine Plattform für Online-Befragungen bereit, in der angemeldete Nutzer\*innen (Mitglieder von #NDRfragt) zu aktuellen Themen befragt werden. Die bei der Anmeldung und innerhalb der Umfragen verarbeiteten Daten werden erst nach einer von Ihnen erteilten Einwilligung und nur zum Zweck der Umfrage verarbeitet. Bei der Anmeldung für eine Mitgliedschaft wird die E-Mail-Adresse an einen vom NDR beauftragten Dienstleister übermittelt und über ein sog. Double-opt-in-Verfahren verifiziert. Darunter ist zu verstehen, dass Ihnen nach Ihrer Anmeldung eine E-Mail an die angegebene E-Mail-Adresse geschickt wird, in der Sie um Bestätigung Ihrer Mitgliedschaft gebeten werden. Rechtsgrundlage ist insoweit die Einwilligung nach Art. 6 Abs. 1 lit. a DSGVO. Die im Rahmen von Umfragen erhobenen Daten werden für die Gestaltung des NDR-Programms und damit zu journalistischen Zwecken verarbeitet. Wenn Sie sich dazu bereiterklären, dass wir (eine Redaktion des NDR oder einer anderen ARD-Anstalt) Sie zum Thema einer Befragung kontaktieren dürfen, oder aus einer Ihrer Antworten zitieren dürfen, gilt dafür ebenfalls die genannte Rechtsgrundlage. Ihre Einwilligung für die Kontaktaufnahme und die damit verbundene Datenübermittlung gilt immer ausschließlich themenbezogen.

Der NDR hat den Dienstleister Alida DE GmbH (Oskar-von-Miller-Ring 20, 80333 München) mit der technischen Durchführung der Umfragen und Forscherinnen und Forscher am GESIS – Leibniz-Institut für Sozialwissenschaften (Quadrat B6 4-5, 68159 Mannheim) zwecks wissenschaftlicher Begleitung beauftragt und Vereinbarungen geschlossen, die die Datenschutzbelange der angemeldeten Mitglieder wahrt. Die Forscherinnen und Forscher am GESIS – Leibniz-Institut für Sozialwissenschaften haben nur einen eingeschränkten Zugang zu den Daten der Mitglieder von #NDRfragt (sie sehen etwa keine Namen und Kontaktdaten).

Sie haben jederzeit die Möglichkeit, Ihre Mitgliedschaft an den regelmäßigen Umfragen durch Betätigen eines Links, der mit jeder Umfragemail bereitgestellt wird oder per E-Mail an ndrfragt@ndr.de zu widerrufen. Damit werden sämtliche von Ihnen gespeicherten personenbezogenen Daten gelöscht, und Sie werden zu Themen, zu denen Sie vorab die Einwilligung erteilt haben, nicht mehr kontaktiert. Zudem können Sie Einwilligungen, zu einzelnen Befragungsthemen kontaktiert zu werden, jederzeit per E-Mail an ndrfragt@ndr.de mit Wirkung für die Zukunft widerrufen, auch ohne Ihre Mitgliedschaft zu kündigen.

8\. Datenverarbeitung bei Nutzung der WhatsApp-Kanäle des NDR
-------------------------------------------------------------

Wenn Sie unsere WhatsApp-Kanäle abonnieren, nutzen Sie damit einen Dienst der WhatsApp Ireland Limited, einem Tochterunternehmen von Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Irland. Für die Nutzung dieses Dienstes gelten die Nutzungsbedingungen und Datenschutzrichtlinien von WhatsApp. Der NDR hat keinen Einfluss auf die Datenverarbeitung durch WhatsApp oder Meta. 

WhatsApp erhebt beim Besuch unseres Kanals unter anderem Informationen wie Ihre IP-Adresse, Gerätedaten, Nutzungsverhalten und weitere technische Informationen (z. B. Sprache, Betriebssystem, App-Version). Diese Daten werden möglicherweise auch in Länder außerhalb der EU übermittelt. Nähere Informationen zur Datenverarbeitung durch WhatsApp finden Sie in deren Datenschutzrichtlinie sowie in der Datenschutzrichtlinie für Kanäle. 

Unsere WhatsApp-Kanäle dienen ausschließlich der einseitigen Information. Ihre Nachrichten an uns werden über die Kanäle nicht übermittelt. Der NDR erhält keine personenbezogenen Daten von Ihnen – mit Ausnahme statistischer, aggregierter Daten zur Reichweite des Kanals (z. B. Anzahl der Follower oder Aufrufe einzelner Beiträge), die uns WhatsApp anonymisiert zur Verfügung stellt. 
...
[https://faq.whatsapp.com/820124435853543/](https://faq.whatsapp.com/820124435853543/ "Whatsapp") 
