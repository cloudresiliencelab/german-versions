...
*   [1\. Zugangsoptionen: STERN.de mit Werbung oder PUR](#1-zugangsoptionen-stern-de-mit-werbung-oder-pur)
*   [2\. Wozu verwenden wir Daten über Sie (Zwecke)?](#2-wozu-verwenden-wir-daten-ueber-sie-zwecke)
*   [3. Welche Daten verwenden wir von Ihnen (Datenarten)?](#3-welche-daten-verwenden-wir-von-ihnen-datenarten)
*   [4. Wer bekommt meine Daten?](#4-wer-bekommt-meine-daten)
*   [5\. Betroffenenrechte](#5-betroffenenrechte)
*   [6\. Wer sind wir (Verantwortlicher)?](#6-wer-sind-wir-verantwortlicher)
*   [7\. Zentraler Anmeldedienst der RTL-Unternehmen](#7-zentraler-anmeldedienst-der-rtl-unternehmen)

Informationen nach Art. 12 – 14 Datenschutzgrundverordnung (DSGVO)

1\. Zugangsoptionen: STERN.de mit Werbung oder PUR
--------------------------------------------------

STERN und STERN.de bieten hochwertige, an journalistischen Standards orientierte Inhalte. Dieses Angebot von STERN.de können Sie entweder über Werbung finanziert oder mit einem kostenpflichtigen Abonnement (PUR) nutzen. Das PUR Abo beinhaltet eine Nutzung unseres digitalen Angebotes ohne programmatische, durch Dritte bereitgestellte Werbung und Tracking.
...
Sofern Sie bereits eine Einwilligung zur Nutzung unseres werbefinanzierten Angebots gegeben haben, können Sie selbstverständlich jederzeit widerrufen. Klicken Sie dafür den Button "Zustimmung widerrufen". Die weitere Nutzung unseres Online-Angebotes ist dann jedoch nur im Rahmen von PUR möglich. 

Zustimmung widerrufen

Sie haben Ihre eventuell gegebene Zustimmung widerrufen.

Sollten Sie Ihre Zustimmung widerrufen, werden Sie beim nächsten Besuch unserer Website erneut darum gebeten, Ihre Zugangsart zu wählen. Auf der entsprechenden Auswahlseite können Sie sich nochmals zwischen der kostenfreien Nutzung mit Werbung und Tracking oder PUR mit deutlich reduzierter Werbung und nahezu ohne Tracking entscheiden.

Bitte beachten Sie, dass Sie unser Angebot ausschließlich mit Werbe-Einwilligung nutzen können, wenn Sie uns über ein Google-Produkt besuchen – etwa mittels eines Links aus der Google-Suche heraus oder im Rahmen der Verlinkung innerhalb eines Google-News-Produkts. Der Grund hierfür ist technischer Natur: In diesem Fall nutzen Sie unser Angebot tatsächlich ausschließlich über Google-Server und nicht unsere eigentliche Website (sogenannte AMP-Seiten, „Accelerated Mobile Pages“).

2\. Wozu verwenden wir Daten über Sie (Zwecke)?
-----------------------------------------------

Bei der Nutzung unserer Angebote verwenden wir personenbezogene Daten (zum Beispiel Ihre IP- oder Email-Adresse) zu verschiedenen Zwecken. Wozu genau wir Daten über Sie verwenden hängt davon ab, wie und welche unserer Dienste Sie nutzten.

Es kann auch vorkommen, dass wir Daten über Sie gleichzeitig zu mehreren Zwecken verwenden, zum Beispiel die Webdaten zur technischen Bereitstellung und die Login-Daten wenn Sie sich in einem Bereich einloggen.
...
#### 2.15 Account- und Datensynchronisierung bei STERN

Wir sind mehr als nur eine Webseite oder ein Heft. Wir sind stern, GEO, Capital, die stern App und noch viel mehr. Um diese Angebote, die technisch und produktseitig sehr unterschiedliche Ansprüche stellen, dennoch auf gleichbleibend hohem Niveau für unsere Leserinnen und Leser zur Verfügung zu stellen, arbeiten die Gruner + Jahr Deutschland GmbH und ihre Schwesterfirmen von RTL Deutschland eng zusammen. Sofern die Bereitstellung von stern-/ GEO-/ Capital-Titeln, -Produkten, oder -Diensten die Verarbeitung personenbezogener Daten erfordert, agieren die beteiligten Unternehmen entsprechend als gemeinsam Verantwortliche gem. Art. 26 DSGVO. Hierzu werden die unter Ziffer 3.12. genannten Datenarten zwischen den beteiligten Unternehmen synchronisiert und ausgetauscht, solange ein aktives Abonnement besteht oder bis Sie Ihre Einwilligung widerrufen. Die gemeinsamen Zwecke sind dabei die Bereitstellung der abonnierten Dienste bzw. Leistungen (Art. 6 Abs. 1 lit. b DSGVO) und, sofern Sie darin eingewilligt haben (Art. 6 Abs. 1 lit. a DSGVO) oder eine anderweitige Rechtsgrundlage (Art. 6 Abs. 1 lit. f DSGVO) vorhanden ist, die werbliche Ansprache bezüglich Produkten und Diensten, die Sie ebenfalls interessieren könnten. Und um uns in dieser Hinsicht zu verbessern und Ihnen bestmöglich nur solche Informationen zuzusenden, die Sie auch interessieren, messen wir grundsätzliche die Interaktion mit unseren Werbemitteln (siehe 2.5. oben). Dieser Messung können Sie unter der unten genannten Datenschutzadresse jederzeit widersprechen. Die einheitliche Führung der Accounts und die Synchronisierung der Daten stellen wir in unserem gemeinsamen Kundenverwaltungssystem (CRM) Braze (siehe Ziffer 4: Empfänger der Daten)

### 2.2 Login / Benutzerkonto

Ein Benutzerkonto können Sie über unsere Website erstellen. Bei der Anmeldung senden wir Ihnen einmalig zur Verifizierung einen Bestätigungslink (Double Opt-In). Nach der Verifizierung können Sie sich mit Ihren Zugangsdaten über das Login-Formular in dein Benutzerkonto einloggen.
...
Die Verwendung der unter Ziffer 2 b genannten Daten zu diesem Zweck erfolgt gem. Art. 6 (1) b DSGVO auf Grundlage des Vertrages, der zwischen uns und Ihnen mit Anlegen des Accounts zustande kommt.

### 2.3 Shop-Seiten

Auf unserer Webseite können Sie auch Produkte oder Dienstleistungen bestellen. Um diese Funktion bereit zu stellen, setzen wir unter anderem Session-Cookies ein, die bewirken, dass unser Shop Ihre Zeit auf unserer Webseite als eine Sitzung erkennt und Sie Ihre Daten beim Aufruf anderer Webseiten oder einer unserer Sub-Seiten nicht nochmal eingeben müssen.
...
Im Rahmen des Bestellprozesses haben Sie auch die Möglichkeit sich mit den eingegebenen Daten ein Kundenprofil mit einer Bestellhistorie anzulegen (vgl. zur Datenverarbeitung dabei Ziffer 1 b.). Dabei handelt es sich jedoch um ein freiwilliges Angebot und eine Bestellung ist auch als Gast ohne Anlage eines Kundenkontos möglich.

### 2.4 Newsletter

#### 2.4.1 Bestellte Newsletter

Auf unserer Webseite können Sie sich zu verschiedenen interessanten Themen kostenfreie Newsletter abonnieren. Dabei werden die Anmeldedaten durch ein Double-Opt-In Verfahren zunächst verwendet, um die angegebene Email-Adresse zu verifizieren und danach bei Erfolg zu Zwecken des Newsletter-Versands. Die einzige Pflichtangabe hierzu ist Ihre Email-Adresse.

Der Versand dieser Newsletter erfolgt auf Basis Ihrer Bestellung und der dabei erteilten Einwilligung in die Verwendung Ihrer Daten gem. Art. 6 (1) a DSGVO. Diese Einwilligung können Sie jederzeit widerrufen und damit den Erhalt dieser Newsletter stoppen.
...
Hierfür werden die im Bestellprozess angegebenen und erhobenen Daten gem. Art. 6 (1) f DSGVO verwendet. Dem Erhalt solcher Mails können Sie jederzeit formlos an die unten genannte Datenschutz-Email widersprechen.
...
Sofern Sie bei uns einen Newsletter abonnieren, würden wir gerne dessen Nutzung erfahren, um den Newsletter, unsere Produkte und Inhalte optimieren zu können.

Hierzu setzen wir sog. Pixel in den Newslettern ein, die messen, ob ein Newsletter geöffnet wird, welche Inhalte angezeigt werden und welche Buttons, Links oder anderen Features im Newsletter angeklickt werden. Abonnieren Sie einen Newsletter, willigen Sie gem. Art. 6 (1) a DSGVO auch in diese Datenerhebung und -verwendung ein. Sofern wir für diese Funktionen Dienstleister einsetzen, erfolgt deren Einbindung mittels einer vertraglichen (Art. 28 DSGVO) oder anderweitigen Absicherung, insbesondere hinsichtlich eines etwaigen Drittlandstransfers (siehe unten Ziffer 3). Zum Widersprechen des Newsletter-Trackings gibt ebenfalls am Ende eines jeden Newsletters einen Funktionslink.
...
Auf der Webseite besteht die Möglichkeit, uns über eine E-Mail-Adresse, die Telefonnummer im Impressum oder das Kontaktformular zu kontaktieren. Nehmen Sie diese Möglichkeit wahr, so werden Ihre angegebenen Daten, insbesondere die Absender-Email und/oder Telefonnummer sowie Ihr Anliegen an uns übermittelt. Abhängig von dem Anliegen (z.B. Fragen zu den Umfragen oder Geltendmachung Ihrer Betroffenenrechte wie etwa einer Auskunft) werden Ihre Kontaktdaten weiterführend (mit Hilfe von Dienstleistern) verarbeitet. Wenn Ihr Anliegen nicht wirklich an uns gerichtet war, kann das auch bedeuten, dass wir Ihre Daten an eine andere Firma innerhalb unseres Konzerns weiterleiten, an die Ihre Anfrage eigentlich adressiert war. Hierzu betrachten wir die im Anliegen übermittelten Daten grundsätzlich als Einheit, die wir in Gänze verwenden und/oder übermitteln.
...
Auf unserer Webseite gibt es die Möglichkeit, mit anderen Nutzer\*innen über verschiedene Themen im Rahmen der "Noch-Fragen-Community" zu diskutieren, sich auszutauschen oder einfach nette Leute zu treffen. Hierzu brauchen Sie zwingend ein Nutzerkonto. Das ist eine Sicherheitsmaßnahme, um unser Forum vor Spam und Trollen zu schützen. Für die Registrierung eines solchen Nutzerkontos ist eine Email-Adresse, Vor- und Nachname, ein Pseudonym als Benutzername im Forum und die Vergabe eines individuellen Passworts erforderlich. Es besteht kein Klarnamenzwang bei der Wahl Ihres Pseudonyms. Wir empfehlen Ihnen zu Ihrer Sicherheit auch, für das Konto keine Passwörter zu verwenden, die Sie anderswo bereits benutzen.    
...
Dabei gibt es im Wesentlichen zwei Möglichkeiten, wie wir Cookies verwenden. Zunächst verwenden wir technisch notwendige Cookies zum Betrieb unserer Webseite (siehe oben Ziffer 2 a). Hierbei ist unser berechtigtes Interesse gem. Art. 6 (1) f DSGVO an einem störungsfreien Betrieb unserer Webseite die Rechtsgrundlage zur Verwendung dieser Cookies. 
...
Die oben beschriebenen Datenverarbeitungen erfolgen zur Wahrung unserer und der berechtigten Interessen der anderen beteiligten Bertelsmann-Unternehmen auf Grundlage von Artikel 6 (1) (f) DS-GVO. Dies geschieht zunächst, damit wir und die anderen beteiligten Bertelsmann-Unternehmen durch eine Anfrage bei der BDS einschätzen können, bei welchen beteiligten Bertelsmann-Unternehmen dieselbe C-ID vorhanden ist und welches Potential der Anonyme Datenkatalog für einen Datenaustausch bieten kann. Ferner soll es uns und den anderen beteiligten Bertelsmann-Unternehmen ermöglichen, Daten unter Nutzung der C-ID auf Basis der Interessensabwägung (siehe Ziffer 2.) oder, soweit vorhanden, deiner Einwilligung untereinander auszutauschen, um Ihnen interessante und nützliche Angebote und Werbung zukommen zu lassen und die jeweiligen Webseiten, Produkte und Dienstleistungen bedarfsgerecht zu gestalten.

Die aktuell beteiligten Bertelsmann-Unternehmen können Sie unter [https://dataservices.bertelsmann.de/participatingcompanies/](https://dataservices.bertelsmann.de/participatingcompanies/) abrufen oder postalisch bzw. per E-Mail unter [datenschutz@bertelsmann.de](mailto:datenschutz@bertelsmann.de) anfordern.
...
*   IP-Adresse;
*   Einzelheiten über die von Ihnen angeforderten Inhalte und über Ihr Nutzungsverhalten (z. B. welche Webseiten und Rubriken wann angesehen wurden);
...
*   Datum und Uhrzeit des Zugriffs, Angaben über den von Ihnen verwendeten Internet-Browser, die Dauer des Besuchs der Website und die letzte zuvor besuchte Seite;
...
### 2.11 Nutzung von Identifikationsmethoden
...
**Wichtig**: Soweit wir auf der Basis des netID Identifiers Nutzerprofile erstellen, fließen in diese Nutzerprofile **keine „sensiblen“ Daten** zur rassischen oder ethnischen Herkunft, politischen Über- zeugungen, eventuellen Gewerkschaftszugehörigkeit, Gesundheit oder Sexualität ein. Diese Nut- zerprofile werden auch nicht dazu verwendet, solche oder vergleichbare Erkenntnisse über Ihre Persönlichkeit zu gewinnen.  
 
...
### 2.12 Unsere Nutzung der Utiq Technologie

Die Utiq Technologie wird von Utiq SA/NV bereitgestellt. Utiq ist ein europäisches Unternehmen. Die Utiq Technologie ist auf den Schutz der Privatsphäre ausgerichtet, indem sie Ihnen Wahlmöglichkeiten und Kontrolle bietet. Gleichzeitig ermöglicht sie ein verantwortungsvolles digitales Marketing durch Webseiten wie uns.

Utiq arbeitet mit verschiedenen teilnehmenden Telekommunikationsanbietern zusammen (s. Liste [hier](https://consenthub.utiq.com/pages/privacy-statement#telecom-operators)), um die Technologie zu betreiben.  
Die Utiq Technologie kann nur aktiviert und genutzt werden, wenn Sie eine Internetverbindung verwenden, die von Utiq\* unterstützt und von einem der unten aufgeführten teilnehmenden Telekommunikationsanbieter in den Ländern bereitgestellt wird, in denen die Utiq Technologie verfügbar ist.

_\* Zu unterstützten Internetverbindungen: In einigen Ländern, in denen wir tätig sind, ist die Utiq Technologie nur verfügbar, wenn eine Mobilfunkverbindung verwendet wird, während sie in anderen Ländern auch auf Breitbandverbindungen (d. h. WLAN) anwendbar ist._

  
Eine Liste der unterstützten Internetverbindungen, sortiert nach Land und Telekommunikationsanbieter, finden Sie [hier](https://consenthub.utiq.com/pages/privacy-statement#telecom-operators).

Die Utiq Technologie ist standardmäßig deaktiviert. Sie kann nur aktiviert werden, wenn Sie Ihre Einwilligung geben, während Sie eine unterstützte Internetverbindung nutzen, die von einem der teilnehmenden Telekommunikationsanbieter bereitgestellt wird.

Wir verwenden die Utiq Technologie auf unserer/unseren Webseite(n). Wenn Sie der Aktivierung dieser Technologie zustimmen, stellt Utiq uns, der G+J Medien GmbH, Chefkoch GmbH, RTL interactive GmbH, ntv Nachrichtenfernsehen GmbH (die Datenverantwortlichen), sogenannte Marketing-Kennungen zur Verfügung. Diese helfen uns, Ihr Surfverhalten zu verstehen und Besuche auf unserer/ unseren Webseite(n) miteinander zu verbinden (jedoch nur dann, wenn Sie der Aktivierung der Utiq Technologie auf jeder einzelnen Webseite zustimmen). Wir verwenden die Kennungen für Aktivitäten wie die Personalisierung von Werbung und Inhalten sowie für Analysen auf dieser und anderen Webseiten, die die Utiq Technologie nutzen, je nachdem, welche Einwilligungen Sie erteilt haben. Die Kennungen werden auch an Partner-Werbeplattformen weitergegeben, wenn dies für die Durchführung der spezifischen Marketing- oder Analyseaktivitäten erforderlich ist.   
...
Wir, die G+J Medien GmbH, Chefkoch GmbH, RTL interactive GmbH, ntv Nachrichtenfernsehen GmbH agieren zusammen mit Utiq als gemeinsame Datenverantwortliche (sog. „joint controllership“) für bestimmte Phasen der Verarbeitung. Im Rahmen dieser Vereinbarung
...
*   **Auf consenthub:** Indem Sie auf das [Utiq Datenschutzportal (“consenthub”)](https://consenthub.utiq.com/) zugreifen, können Sie alle Utiq Einwilligungen widerrufen, die Sie auf den Webseiten, die die Utiq Technologie nutzen, erteilt haben.
...
_\* Dies gilt für Utiq-Einwilligungen, die entweder von Ihnen oder, falls Sie eine gemeinsame Internetverbindung nutzen, von einem Mitglied Ihres Haushalts erteilt werden._

### 2.13 Nutzungs- und Reichweitenmessung für die AGF Marktstudie

Die Seitenaufrufe unseres Angebotes und die Nutzung der Videoangebote werden zur Ermittlung von Reichweitenkennzahlen verwendet, welche durch die AGF Videoforschung GmbH im Rahmen einer Marktstudie veröffentlicht werden und darüber hinaus uns zu internen Analysezwecken dienen. Die dabei erhobenen Daten dienen weder der Profilbildung zu Werbezwecken noch anderen Zwecken außerhalb der Reichweitenmessung und -analyse. Die Art der Datenverarbeitung unterscheidet sich für Nutzer und Studienteilnehmer, den s.g. Panellisten.  
...
*   Für die Erhebung und Verarbeitung von Nutzungsinformationen zum Zweck der Messung ist die RTL Deutschland GmbH verantwortlich.
*   Für die Nutzung von Datenschutzeinstellungen des Privacy Centers sind wir zusammen mit der RTL Deutschland GmbH verantwortlich.  
     

Ihre Datenschutzrechte können Sie sowohl bei uns wie unter Ziffer 6 näher beschrieben, als auch bei der RTL Deutschland GmbH unter den oben in diesem Abschnitt angeführten Kontaktdaten geltend machen. Sie erhalten eine Auskunft grundsätzlich von der Stelle, bei der Rechte geltend gemacht wurden. Den Datenschutzbeauftragten der RTL Deutschland GmbH erreichen Sie unter der oben genannten Adresse oder Mailadresse und dem Stichwort “Datenschutzbeauftragter”.
...
*   Ihre Anmelde- und Teilnahmedaten brauchen wir, um Ihnen einen Zugang bereitzustellen, damit Sie am Event selbst teilnehmen, mitreden und die ganze Experience mitnehmen können
*   Ihre Anschrift brauchen wir, um Ihnen Unterlagen zuschicken zu können
*   Beide vorgenannten Datenarten zzgl. Ihrer Zahlungsdaten speichern wir in unseren Systemen, um Ihr Ticket im Rahmen Ihrer Bestellung zu verwalten.
...
Die im Folgenden aufgelisteten Arten von Daten verwenden wir über Sie, abhängig von Ihrer Nutzung unserer Angebote.
...
#### 3.12 Verwendete Daten bei den synchronisierten Nutzer-Abonnements zwischen G+J und RTL 

Zur Synchronisierung Ihres/Ihrer Accounts und Abonnements verwenden wir in erster Linie Ihre Registrierungsdaten, sprich Anrede, Vor- und Nachname, Email-Adresse, Rechnungsinformationen und bestellte Produkte/Dienste/Abonnements. Zu diesen klassischen Account-Daten speichern wir Ihre Ansprachepräferenzen und Einwilligungen, um sicherzustellen, dass wir Sie nur in dem Maße ansprechen, wir Sie dies wünschen und gestattet haben. Darüber hinaus verarbeiten wir systemseitig Informationen, die Ihnen ermöglichen, auf die gebuchten bzw. bestellten Inhalte zuzugreifen. Dies sind in erster Linie Zugriffsrechte (d.h. auf welche Inhalte Sie zugreifen können), Login-Credentials (verschlüsselt in einer separaten Datenbank), aber auch Systeminformationen wie Ihr Endgerätetyp (mobil/App, TV, Desktop, Tablet – wonach sind insb. die Ausspielformate ändern können, um Ihnen die bestmöglichen Inhalte zu bieten) oder Zugriffszeiten. Darüber hinaus speichern wir die in Ziffer 2.15 beschriebenen Interaktionsdaten, bspw. wenn Sie in einem Newsletter auf einen Link klicken und dann in einem unserer (Partner-)Shops etwas kaufen.
...
*   Email-Adresse(n)
*   Profil-Informationen, die durch Sie selbst eingetragen werden (und die leer bleiben, sofern Sie keine eintragen), z.B. Name(n), Anschrift, externe Profile, Vorlieben, Abonnements  
     
...
Um unsere Newsletter bereitzustellen, verwenden wir Ihre Kontaktdaten (Name und Email-Adresse), die Sie bei der Bestellung des Newsletters oder beim Kauf der Ware oder der Dienstleistung angegeben haben.

Sofern es sich um einen bezahlten Newsletter handelt, verwenden wir für die Dauer des Abonnements Ihre Rechnungsdaten wie Kontonummer, Kontoinhaber, Anzahl gelieferte Newsletter, An- und Abmeldung, ggf. Vergünstigungen bei anderen Produkten.  
 

### 3.5 Newsletter-Tracking

Im Rahmen des Newsletter-Trackings erheben, verwenden und speichern wir Daten über Ihre Nutzung unserer Newsletter. Dabei werden folgende Daten erhoben:

*   Die unter Ziffer 2 a genannten Daten werden auch zu diesem Zweck erhoben und verwendet
*   Darüber hinaus erheben wir Klick- und Scrollverhalten innerhalb des Newsletters, insbesondere, wenn Sie durch eine Anzeige oder einen Link im Newsletter auf eine unserer Shopseiten kommen.  
     
...
Für die Bereitstellung und den Betrieb des Forums benötigen wir Ihre Email-Adresse, Ihren Vor- und Nachnamen, ein Pseudonym als Benutzername im Forum ein individuelles Passwort. Das Passwort speichern wir zu Ihrer Sicherheit in unserer Datenbank in gehashter Form.

Zusätzlich zu diesen Daten, die wir zur Bereitstellung Ihres Zugangs benötigen, speichern wir Daten über Ihre Nutzung unseres Forums. Dabei handelt es sich einerseits um technisch generierte Informationen wie beispielsweise Ihren Login (Zeitpunkt und Datum), Ihre IP-Adresse und weitere unter 2 a genannte Daten. Darüber hinaus speichern und veröffentlichen wir Ihre Beiträge in Foren – behalten uns allerdings auch vor, diese selbstständig in eigenem Ermessen zu löschen.
...
1.  Anmelde- und Teilnahmedaten: Beim Kauf Ihres Tickets müssen Sie Ihren Namen und Ihre Email-Adresse angeben. Dorthin schicken wir die Einwahldaten, mit denen Sie am Event selbst teilnehmen können. Da das Format aktuell wegen Corona digital stattfindet, verarbeiten wir technische Daten, wenn Sie sich einwählen, wie Ihre IP, Ihren Browser, dessen Version, Ihre Bildschirmeinstellungen, Auflösung, Betriebssystem und andere technisch erforderliche Dinge. Nehmen Sie aktiv durch Wortbeiträge und Anschalten Ihrer Kamera teil – worüber wir uns freuen würden – dann erheben, verarbeiten und übermitteln diese Daten auch an alle anderen Teilnehmer. Möchten Sie das nicht, können Sie natürlich auch ohne Kamera und Ton teilnehmen.
2.  Ihre Anschrift verwenden wir, um Ihnen ein Getränkepaket zuzuschicken – Sie sollen ja nicht auf dem Trockenen sitzen!
3.  Rechnungsdaten verarbeiten wir, um Ihren Ticketkauf und Teilnahme abzuwickeln. Hierfür werden Ihre Kontodaten, Kreditkartendaten oder diejenigen Daten verarbeitet und gegebenenfalls auch an Dritte (Kreditinstitut, Zahlungsdienste) weitergegeben, abhängig davon, wie und womit Sie zahlen; beispielsweise tauschen wir Daten mit Paypal aus, wenn Sie bei Ihrer Ticketbestellung deren Service als Bezahlmethode nutzen.  
     
...
Braze wird von uns zur gemeinsamen Verwaltung von Abonnent:innen-Daten und der in Ziffer 2.15. beschriebenen Synchronisierung der Daten und Datennutzung zwischen den gemeinsamen Verantwortlichen der G+J und RTL Deutschland eingesetzt. Braze, ein Service der Braze, Inc. (63 Madison Building 28 East 28th Street, 12th Floor Mailroom, New York, NY 10016, USA), ist von RTL Deutschland gem. Art. 28 DSGVO eingebunden worden und gewährleistet anhand von angemessenen Garantien i.S.v. Kap. V DSGVO, dass Ihre Daten auf eine Weise gespeichert sind, die dem europäischen Datenschutzniveau entspricht.
...
Datenschutzrechtlich verantwortlich ist für die hierin beschriebenen Datenverarbeitungen die G+J Medien GmbH, Am Baumwall 11, 20459 Hamburg, eMail: [datenschutz@stern.de](mailto:datenschutz@stern.de)  mit Ausnahme für die in Ziffer 2.8 genannten Verarbeitungen bei Abschluss eines PUR oder stern+ - Abonnements. Dafür verantwortlich ist die RTL interactive GmbH, Picassoplatz 1, 50679 Köln, E-Mail: [datenschutz@rtl.de](mailto:datenschutz@rtl.de)  Gleiches gilt für Verarbeitungen im Zusammenhang mit Newslettern, sofern die RTL interactive GmbH der Absender ist. Wenn Sie also mehr Informationen über Ihre Datenverarbeitung erhalten oder eine Betroffenenrechte ausüben möchten, können Sie sich jederzeit an uns wenden. Unsere Datenschutzbeauftragten erreichen Sie jeweils unter den gerade genannten Anschriften mit dem Zusatz „An den Datenschutzbeauftragten“ und bitte einem Hinweis in Ihrer Nachricht, dass Sie sich auf diese Webseite beziehen.

7\. Zentraler Anmeldedienst der RTL-Unternehmen
-----------------------------------------------

Die Tochterunternehmen der RTL Deutschland GmbH haben sich zusammengeschlossen mit dem Ziel, für die Verwaltung von Abonnements und Nutzerkonten einen einheitlichen, zentralen Dienst einzurichten. Die beteiligten Unternehmen finden sie am Ende dieses Abschnitts.

**Verarbeitungszwecke:**

Gemeinsame Ziele und damit Zwecke der Datenverarbeitung ist die Bereitstellung von abonnierten Inhalten und Funktionen, die Verbesserung der Wirtschaftlichkeit der für Registrierung, Nutzer- und Abonnentenverwaltung notwendigen Infrastruktur, eine einfachere Benutzerführung für den Kunden, die Reduzierung von seitens des Kunden nicht erforderlichen bzw. gewünschten Benutzerkonten sowie die Erfolgsprognose potenzieller werblicher Maßnahmen mittels statistischer Überschneidungsanalyse von Nutzergruppen der verschiedenen Angebote.

**Gemeinsame datenschutzrechtliche Verantwortung**

Für die Verarbeitung Ihrer Daten sind die beteiligten Unternehmen gemeinsam datenschutzrechtlich Verantwortliche. Insoweit haben die Unternehmen in einer gemeinsamen Vereinbarung nach Art. 26 DS-GVO die Erfüllung der sich aus der DSGVO ergebenen Pflichten festgelegt. Dies betrifft insbesondere die Wahrnehmung der Rechte der betroffenen Personen und die Erfüllung der Informationspflichten gemäß den Artikeln 13 und 14 DS-GVO.

Diese Vereinbarung ist notwendig, da die personenbezogenen Daten in unterschiedlichen Zuständigkeiten verarbeitet werden. Auch wenn eine gemeinsame Verantwortlichkeit besteht, erfüllen die Parteien die datenschutzrechtlichen Pflichten entsprechend dieser jeweiligen Zuständigkeiten.

Die Authentifizierung und Autorisierung der Nutzer erfolgt durch die RTL interactive GmbH. Das heißt, die RTL interactive GmbH speichert Ihren Nutzernamen (Email-Adresse), Ihr Passwort sowie die abgeschlossenen Abonnements für Inhalte und Funktionen aller beteiligten Unternehmen.

Die Analyse der Überschneidung von Nutzergruppen über alle verwalteten Nutzerkonten hinweg erfolgt durch die RTL interactive GmbH. Die Ergebnisse dieser Analyse werden den beteiligten Unternehmen in aggregierter, d.h. anonymer Form zur Verfügung gestellt und dienen dazu, das Inhalte-Angebot der beteiligten Unternehmen als Gesamtheit zu optimieren und den Erfolg potenzieller werblicher Maßnahmen zu prognostizieren.

Die Bereitstellung von Inhalten und Funktionen geschieht durch das jeweilige Unternehmen, dessen Kunde Sie sind.

Die Verarbeitung von Daten über die o.g. Zwecke hinaus ist nicht Teil der in diesem Abschnitt erläuterten gemeinsamen datenschutzrechtlichen Verantwortung.

**Datenkategorien**

Die für die Erreichung der gemeinsamen Ziele verarbeiteten Daten umfassen Ihre Email-Adresse, Ihr verschlüsseltes Passwort sowie die Kennungen der gebuchten Abonnements und Funktionen. Diese Daten sind für die Erfüllung der Verarbeitungszwecke erforderlich.

**Rechtsgrundlage**

Rechtsgrundlage der zentralen Verarbeitung von Anmeldedaten und Abonnements sowie für die Bereitstellung von Inhalten und Funktionen entsprechend der von Ihnen abgeschlossenen Abonnements ist die Vertragserfüllung gemäß Art. 6 Abs. 2 lit. b DSGVO.

Rechtsgrundlage für die Überschneidungsanalyse der Nutzergruppen ist nach sorgfältiger Abwägung der daraus entstehenden Risiken für die Rechte und Freiheiten der betroffenen Personen unser legitimes und berechtigtes Interesse an einer übergreifenden Optimierung des Inhalte-Angebotes der beteiligten Unternehmen gemäß Art. 6 Abs. 1 lit. f DSGVO.

**Ihre Rechte**

Bei Gründen, die sich aus Ihrer besonderen Situation ergeben, können Sie Widerspruch gegen die Verarbeitung im Rahmen des zentralen Anmeldedienstes einlegen. Ihre Daten werden dann nicht in personenbezogener Form weiterverarbeitet, es sei denn, wir können zwingende schutzwürdige Gründe für die Verarbeitung nachweisen, die Ihre Interessen, Rechte und Freiheiten überwiegen, oder die Verarbeitung dient der Geltendmachung und Ausübung von oder der Verteidigung gegen Rechtsansprüche (Art. 21 Abs. 1 DSGVO).

Sie haben jederzeit das Recht auf Auskunft über die zu Ihrer Person gespeicherten Daten. Sollten Daten über Ihre Person falsch oder nicht mehr aktuell sein, haben Sie das Recht deren Berichtigung zu verlangen. Unter bestimmten Voraussetzungen haben Sie außerdem das Recht, die Löschung oder Einschränkung der Verarbeitung Ihrer Daten zu verlangen.

Schließlich haben Sie auch das Recht, eine elektronische Kopie Ihrer Daten herauszuverlangen oder die Daten an einen anderen Anbieter weiterleiten zu lassen

Ihre Datenschutzrechte können Sie sowohl bei der

RTL interactive, Picassoplatz 1, 50679 Köln

E-Mail unter [datenschutz@rtl.de](mailto:datenschutz@rtl.de "mailto:datenschutz@rtl.de")

als auch bei in dieser Datenschutzerklärung genannten Verantwortlichen Stelle geltend machen. Sie erhalten die Auskunft grundsätzlich von der Stelle, bei der Rechte geltend gemacht wurden.

Sie haben auch das Recht sich an eine Datenschutzbehörde zu wenden und dort Beschwerde einzureichen.

**Beteiligte Unternehmen**

Die folgenden Unternehmen nutzen den zentralen Anmeldedienst der RTL-Unternehmen in Deutschland.

*   RTL Interactive GmbH
*   G+J Medien GmbH
*   G+J Deutschland GmbH
*   ntv Nachrichrichtenfernsehen GmbH

Stand: 25.07.2024

*   [Internetauftritt](https://www.stern.de/digital/online/themen/internetauftritt-4137834.html)